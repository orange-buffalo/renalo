...
- Dashboard analytics date filtering is dashboard-specific browser-persisted state. Persist presets symbolically so relative ranges are recalculated when restored, while custom ranges retain their exact dates.
