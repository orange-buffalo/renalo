...
- Overview **More filters** controls must reserve space for their active-count badge so an open desktop popover stays anchored when filters change; on mobile, render the filters as a closable full-page modal.
