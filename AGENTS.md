...
- Forms that load existing records or required reference data must keep the form surface in place and block it with the shared `FormLoadingOverlay` using the Untitled dot-circle loading indicator.
